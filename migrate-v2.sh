...
wget -qO /usr/local/bin/wibu-utils.sh "${REPO}/wibu-utils.sh"
...
cd /usr/local/bin
wget -qO m-vless "${REPO}/menu/m-vless.sh"
wget -qO m-vmess "${REPO}/menu/m-vmess.sh"
wget -qO m-trojan "${REPO}/menu/m-trojan.sh"
wget -qO m-setting "${REPO}/menu/m-setting.sh"
wget -qO m-backup "${REPO}/menu/m-backup.sh"
wget -qO bot-daemon "${REPO}/menu/bot-daemon.sh"
wget -qO cek-trafik "${REPO}/menu/cek-trafik.sh"
wget -qO menu-recovery "${REPO}/menu/menu-recovery.sh"
wget -qO menu-lock "${REPO}/menu/menu-lock.sh"
wget -qO menu-unlock "${REPO}/menu/menu-unlock.sh"
wget -qO common.sh "${REPO}/common.sh"
chmod +x *

cd /usr/local/sbin
wget -qO lock-user "${REPO}/sbin/lock-user"
wget -qO unlock-user "${REPO}/sbin/unlock-user"
wget -qO algojo-wibu "${REPO}/sbin/algojo-wibu"
chmod +x *
