...
rm -rf /usr/local/bin/menu* /usr/local/bin/m-* /usr/local/bin/lock-user /usr/local/bin/unlock-user /usr/local/bin/bot-daemon /usr/local/bin/cek-trafik /usr/local/bin/watchdog.sh /usr/local/bin/renew-cert-wibu.sh /usr/local/bin/xp
