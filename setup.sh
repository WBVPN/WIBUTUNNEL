...
<b>User     :</b> <code>${user}</code>
<b>Alasan   :</b> Kuota Habis
<b>Durasi   :</b> Permanen (sampai di-unlock manual)
<b>Waktu    :</b> ${WAKTU}
<b>Domain   :</b> <code>${DOMAIN}</code>
